...
class MateriaRepository:
    ...
    def adicionar(self, obj_materia):
        conn = self.conectar()
        cursor = conn.cursor()
        cursor.execute("INSERT INTO materiases (nome, sigla_curricular, descricao) VALUES (?, ?, ?);", (obj_materia.nome, obj_materia.sigla_curricular, obj_materia.descricao))
        conn.commit()
    ...
    def atualizar(self, obj_materia):
        ...
        # Buscar materias antes de atualizar
